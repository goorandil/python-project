...
class RightFrame(tk.Frame):
    def __init__(self, parent):
        ...
        title_label = tk.Label(self, text="My Application", font=("Arial", 30))
        title_label.pack(pady=0)

        # Create a listbox to display the CSV filenames
        self.csv_listbox = tk.Listbox(self, width=50, font=("Arial", 25))
        ...
        self.csv_treeview = ttk.Treeview(treeview_frame, show="headings")
